...
this['email-panel'] = function (_, Kotlin) {
  ...
  var jsObject = defineInlineFunction('email-panel.jsObject_5ij4lk$', function (init) {
    var o = {};
    init(o);
    return o;
  });
  ...
  sendMail$lambda$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: []
  };
  ...
  Object.defineProperty(_, 'fromMail', {
    get: function () {
      return fromMail;
    }
  });
  Object.defineProperty(_, 'toMail', {
    get: function () {
      return toMail;
    }
  });
  Object.defineProperty(_, 'subject', {
    get: function () {
      return subject;
    }
  });
  Object.defineProperty(_, 'signature', {
    get: function () {
      return signature;
    }
  });
  ...
  Object.defineProperty(_, 'clearBtn', {
    get: function () {
      return clearBtn;
    },
    set: function (value) {
  ...
  Object.defineProperty(_, 'sendBtn', {
    get: function () {
      return sendBtn;
    },
    set: function (value) {
  ...
  Object.defineProperty(_, 'attachBtn', {
    get: function () {
      return attachBtn;
    },
    set: function (value) {
  ...
  $$importsForInline$$['email-panel'] = _;
  ...
  main([]);
  Kotlin.defineModule('email-panel', _);
  return _;
